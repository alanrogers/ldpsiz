...
\-Estimate \-D from partially phased diploid data using the \-E\-M algorithm. \begin{DoxyCopyright}{\-Copyright}
...
\paragraph[{\-Dsq\-Data\-\_\-reset}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Dsq\-Data\-\_\-reset} (
...
\paragraph[{find\-\_\-\-D}]{\setlength{\rightskip}{0pt plus 5cm}double {\bf find\-\_\-\-D} (
\begin{DoxyParamCaption}
\item[{double}]{\-D0, }
\item[{{\bf \-Dsq\-Data} $\ast$}]{dd}
\end{DoxyParamCaption}
...
\mbox{\tt in}  & {\em w0} & \-Starting value for \-E\-M algorithm. \\
\hline
...
\paragraph[{get\-D}]{\setlength{\rightskip}{0pt plus 5cm}static double {\bf get\-D} (
\begin{DoxyParamCaption}
\item[{double}]{w, }
\item[{{\bf \-Dsq\-Data} $\ast$}]{dd}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline, static\mbox{]}}}}\label{em_8c_aff0275c84deb2d4b7de0f4748eec1256}
...
\paragraph[{minimize1\-D}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf minimize1\-D} (
\begin{DoxyParamCaption}
\item[{double $\ast$}]{\-D, }
\item[{{\bf \-Dsq\-Data} $\ast$}]{dd}
\end{DoxyParamCaption}
...
\paragraph[{neg\-Ln\-L\-\_\-df}]{\setlength{\rightskip}{0pt plus 5cm}double {\bf neg\-Ln\-L\-\_\-df} (
\begin{DoxyParamCaption}
\item[{double}]{\-D, }
\item[{void $\ast$}]{data}
\end{DoxyParamCaption}
...
\paragraph[{neg\-Ln\-L\-\_\-df12}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf neg\-Ln\-L\-\_\-df12} (
\begin{DoxyParamCaption}
\item[{double}]{\-D, }
\item[{double $\ast$}]{df, }
\item[{double $\ast$}]{ddf, }
...
\paragraph[{neg\-Ln\-L\-\_\-fddf}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf neg\-Ln\-L\-\_\-fddf} (
\begin{DoxyParamCaption}
\item[{double}]{\-D, }
\item[{double $\ast$}]{f, }
\item[{double $\ast$}]{df, }
...
\paragraph[{neg\-Ln\-L\-\_\-fdf}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf neg\-Ln\-L\-\_\-fdf} (
\begin{DoxyParamCaption}
\item[{double}]{\-D, }
\item[{double $\ast$}]{f, }
\item[{double $\ast$}]{df, }
...
\paragraph[{next\-\_\-w}]{\setlength{\rightskip}{0pt plus 5cm}static double {\bf next\-\_\-w} (
\begin{DoxyParamCaption}
\item[{double}]{w, }
\item[{{\bf \-Dsq\-Data} $\ast$}]{dd}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline, static\mbox{]}}}}\label{em_8c_adb1dfc954ce3aba4150aba1ca6dbeedc}
