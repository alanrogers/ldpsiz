...
\item 
struct \hyperlink{structparam__struct}{param\-\_\-struct}
\item 
...
\item 
\hypertarget{strobeck_8c_ae0fa2b2f6b433f96da3cdaf7d1889ad4}{void $\ast$ {\bfseries Strobeck\-Data\-\_\-new} (void)}\label{strobeck_8c_ae0fa2b2f6b433f96da3cdaf7d1889ad4}
...
\paragraph[{onestep}]{\setlength{\rightskip}{0pt plus 5cm}static int onestep (
...
)\hspace{0.3cm}{\ttfamily [static]}}}\label{strobeck_8c_a71faf4c2f99ff490ff7c1dc831d86d79}
...
Referenced by iterate(), Strobeck\-\_\-dydt(), and Strobeck\-\_\-get\-\_\-sigdsq().
...
\paragraph[{Strobeck\-\_\-dydt}]{\setlength{\rightskip}{0pt plus 5cm}int Strobeck\-\_\-dydt (
\begin{DoxyParamCaption}
...
\mbox{\tt in}  & {\em y1} & is the current vector of identity coefficients. \\
\hline
...
\hline
\mbox{\tt in}  & {\em params} & points to a structure of type \hyperlink{structparam__struct}{param\-\_\-struct}. \\
\hline
\end{DoxyParams}
...
\paragraph[{Strobeck\-\_\-evolve\-Discrete}]{\setlength{\rightskip}{0pt plus 5cm}int Strobeck\-\_\-evolve\-Discrete (
\begin{DoxyParamCaption}
...
\paragraph[{Strobeck\-\_\-get\-\_\-sigdsq}]{\setlength{\rightskip}{0pt plus 5cm}double Strobeck\-\_\-get\-\_\-sigdsq (
\begin{DoxyParamCaption}
\item[{double}]{y\mbox{[}$\,$\mbox{]}, }
\item[{int}]{two\-Nsmp}
\end{DoxyParamCaption}
...
\paragraph[{Strobeck\-\_\-geteq}]{\setlength{\rightskip}{0pt plus 5cm}int Strobeck\-\_\-geteq (
\begin{DoxyParamCaption}
...
\paragraph[{state\-Lbl}]{\setlength{\rightskip}{0pt plus 5cm}const char$\ast$ state\-Lbl\mbox{[}D\-I\-M\mbox{]}\hspace{0.3cm}{\ttfamily [static]}}}\label{strobeck_8c_a8ff690d75a6011defbc74c5de4edebaa}
{\bfseries Initial value\-:}
\begin{DoxyCode}
= \{ \textcolor{stringliteral}{"phiA"},
    \textcolor{stringliteral}{"phiB"},
    \textcolor{stringliteral}{"phiAB"},
    \textcolor{stringliteral}{"gammaAB"},
    \textcolor{stringliteral}{"deltaAB"}
\}
\end{DoxyCode}
