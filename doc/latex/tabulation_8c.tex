...
Class \hyperlink{struct_tabulation}{Tabulation} tabulates data used to calculate $sigma_d^2$.  
...
\hypertarget{tabulation_8c_adbf41e2920f1934a56548363a0a3190c}{int {\bfseries Tabulation\+\_\+report} (\hyperlink{struct_tabulation}{Tabulation} $\ast$tab, double $\ast$sep\+\_\+cm, long unsigned $\ast$nobs, double $\ast$sigdsq, double $\ast$rsq)}\label{tabulation_8c_adbf41e2920f1934a56548363a0a3190c}
