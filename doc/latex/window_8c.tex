...
\paragraph[{S\+N\+P\+\_\+get\+Dsq\+\_\+haploid}]{\setlength{\rightskip}{0pt plus 5cm}double S\+N\+P\+\_\+get\+Dsq\+\_\+haploid (
\begin{DoxyParamCaption}
\item[{double $\ast$}]{pqpq, }
\item[{{\bf S\+N\+P} $\ast$}]{x, }
\item[{{\bf S\+N\+P} $\ast$}]{y}
...
\paragraph[{Window\+\_\+new}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Window}$\ast$ Window\+\_\+new (
\begin{DoxyParamCaption}
