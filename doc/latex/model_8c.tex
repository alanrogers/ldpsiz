...
\-Functions for objects of type \hyperlink{struct_model}{\-Model}, a generic class whose details are implemented elsewhere. \-The \hyperlink{struct_model}{\-Model} class generalizes the task of calculating the expected value of an \-L\-D statistic from parameter values involving recombination rate, c, mutation rate, u, and the history of population size.
