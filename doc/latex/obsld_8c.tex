\hypertarget{obsld_8c}{\subsection{obsld.\-c File Reference}
\label{obsld_8c}\index{obsld.\-c@{obsld.\-c}}
}
...
\begin{DoxyCompactItemize}
\item 
\hypertarget{obsld_8c_ad96d407a911fbb914fa8e4cfbf2faf0f}{static void \hyperlink{obsld_8c_ad96d407a911fbb914fa8e4cfbf2faf0f}{usage} (void)}\label{obsld_8c_ad96d407a911fbb914fa8e4cfbf2faf0f}

\begin{DoxyCompactList}\small\item\em Print usage message and abort. \end{DoxyCompactList}\item 
\hypertarget{obsld_8c_a66191769f33182335e7077162760c2fa}{void \hyperlink{obsld_8c_a66191769f33182335e7077162760c2fa}{Thread\-Arg\-\_\-print} (\hyperlink{struct_thread_arg}{Thread\-Arg} $\ast$targ, F\-I\-L\-E $\ast$ofp)}\label{obsld_8c_a66191769f33182335e7077162760c2fa}

\begin{DoxyCompactList}\small\item\em Print \hyperlink{struct_thread_arg}{Thread\-Arg} object. \end{DoxyCompactList}\item 
void $\ast$ \hyperlink{obsld_8c_abb42aeddc60869b8f9e0c76a7974cb54}{threadfun} (void $\ast$varg)
\begin{DoxyCompactList}\small\item\em {\ttfamily obsld} runs a copy of this function within each thread. \end{DoxyCompactList}\item 
\hypertarget{obsld_8c_a3c04138a5bfe5d72780bb7e82a18e627}{int {\bfseries main} (int argc, char $\ast$$\ast$argv)}\label{obsld_8c_a3c04138a5bfe5d72780bb7e82a18e627}

\end{DoxyCompactItemize}


\subsubsection{Detailed Description}
Estimate L\-D from genetic data. \label{obsld_8c_obsld}%
\hypertarget{obsld_8c_obsld}{}%
\subsubsection*{{\ttfamily obsld}, a program that estimates L\-D from genetic data }
...
By default, the program uses as many threads as there are cores on the machine. To change this, use the command-\/line option {\ttfamily -\/-\/threads} or set {\ttfamily nthreads} in the file {\ttfamily ldpsiz.\-ini}. \begin{DoxyVerb}usage: obsld [options] input_file_name
...
\hypertarget{obsld_8c_abb42aeddc60869b8f9e0c76a7974cb54}{\index{obsld.\-c@{obsld.\-c}!threadfun@{threadfun}}
\index{threadfun@{threadfun}!obsld.c@{obsld.\-c}}
\paragraph[{threadfun}]{\setlength{\rightskip}{0pt plus 5cm}void$\ast$ threadfun (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{varg}
\end{DoxyParamCaption}
)}}\label{obsld_8c_abb42aeddc60869b8f9e0c76a7974cb54}
