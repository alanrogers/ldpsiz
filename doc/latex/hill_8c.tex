...
\paragraph[{iterate}]{\setlength{\rightskip}{0pt plus 5cm}static int iterate (
\begin{DoxyParamCaption}
\item[{double}]{y\mbox{[}$\,$\mbox{]}, }
\item[{int}]{t, }
\item[{double}]{two\-N, }
...
Referenced by Hill\-\_\-evolve\-Discrete().
...
\item[{double}]{u}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}}\label{hill_8c_aced5e1a804d1c760589f6df5c827b79e}
...
\paragraph[{state\-Lbl}]{\setlength{\rightskip}{0pt plus 5cm}const char$\ast$ state\-Lbl\mbox{[}D\-I\-M\mbox{]}\hspace{0.3cm}{\ttfamily [static]}}}\label{hill_8c_a8ff690d75a6011defbc74c5de4edebaa}
{\bfseries Initial value\-:}
\begin{DoxyCode}
= \{ \textcolor{stringliteral}{"Ha*Hb"},
    \textcolor{stringliteral}{"4S[abD]"},
    \textcolor{stringliteral}{"2S[D^2]"},
